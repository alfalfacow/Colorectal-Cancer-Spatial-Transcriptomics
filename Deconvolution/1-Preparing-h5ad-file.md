# Preparing h5ad file
As input, Cell2Location requires a single cell reference dataset and a spatial transcriptomics dataset, both in the .h5ad file format. I have prepared the single cell reference data already, so below is a guide on how to get a .h5ad file from a spatial transcriptomics dataset (Visium)!
